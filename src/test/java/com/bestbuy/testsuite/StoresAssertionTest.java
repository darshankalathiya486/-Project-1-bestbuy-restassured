...
public class StoresAssertionTest{
    ...
    // Test 4 : Check the multiple ‘Names’ in the ArrayList (Roseville, Burnsville, Maplewood)
    @Test
    public void test004(){
    ...
    //Test 6 : Check hash map values ‘createdAt’ inside storeservices map where store name = Roseville
    @Test
    public void test006(){
    ...
    @Test
    public void test007(){
        response.body("data.findAll{it.name == 'Burnsville'}", hasItem(hasEntry("state", "MN")));
    }

    //Test 8 :Verify the store name = Rochester of 9th store
    @Test
    public void test008(){
